export class Render {
  ...
  static homePageAllCompanies(allCompanies) {
    ...
    allCompanies.forEach(companie => {
      !sections.includes(companie.sectors.description) ? sections.push(companie.sectors.description) : null
    })
  ...
  static somePartners(companie) {
    ...
    li.append(companieName, companieDescription, companieSector, companieOpeningHour)
  ...
  static renderDepartmentCard(department) {
    ...
    div.append(departmentTitle, departmentDescription)
